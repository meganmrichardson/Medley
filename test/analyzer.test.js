...
const semanticChecks = [
  ...
  ["call of assigned functions", "intberry blend fn (intberry five) -> intberry seven is 2 plus five | juice seven | <- fn(5) |"],
  [
    "binary expression",
    "intberry seven is 2 plus 5 |"
  ]
  // (;
]
